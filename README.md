...
- **Food & drink (Godot-only, post-migration):** Basic Meal ($8, +35 Hunger)
  and Basic Drink ($3, +30 Thirst) bought and immediately consumed through one
  authoritative purchase path — all-or-nothing, zero time advance, dead- and
