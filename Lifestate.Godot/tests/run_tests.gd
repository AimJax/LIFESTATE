...
const TestFoodDrink = preload("res://tests/test_food_drink.gd")
const TestHousing = preload("res://tests/test_housing.gd")
...
func _initialize() -> void:
	...
	TestEconomy.run(harness)
	TestFoodDrink.run(harness)
	TestHousing.run(harness)
